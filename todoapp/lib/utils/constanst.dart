...
dynamic alertExpiredTime(BuildContext context) {
  return PanaraInfoDialog.showAnimatedGrow(
    context,
    title: MyString.oopsMsg,
    message: "There are a some tasks that are about to expire!",
    buttonText: "i know! Thanks!",
    onTapDismiss: () {
      Navigator.pop(context);
    },
    panaraDialogType: PanaraDialogType.warning,
...
enum StatusTask { completed, uncompleted, inProgress, expired }
