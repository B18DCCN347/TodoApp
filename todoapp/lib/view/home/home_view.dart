...
class _HomeViewState extends State<HomeView> {
  ...
  int checkDoneTask(List<Task> task) {
    ...
    for (Task doneTasks in task) {
      if (doneTasks.statusTask == StatusTask.completed.name) {
        i++;
      }
    }
    return i;
  ...
  initBox() async {
    ...
    Box<Task>? box = await Hive.openBox<Task>("tasksBox");
    ;
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return Dismissible(
                          ...
                          onDismissed: (direction) {
                            base.dataStore.delete(task: task);
                          },
                          key: Key(task.id),
                          child: TaskWidget(
                            task: task,
    ...
    return Container(
      ...
      child: Column(
        children: [
          const CircleAvatar(
            radius: 50,
            backgroundImage: AssetImage('assets/img/avt.jpeg'),
          ),
          const SizedBox(
            height: 8,
          ),
          Text("Lê Hoàng Long is me", style: textTheme.headline2),
          Text("Thợ Code có 102", style: textTheme.headline3),
          Container(
